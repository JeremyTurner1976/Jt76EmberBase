...
namespace Jt76EmberBase.Common.Services
{
    ...
    public class ConfigService : IConfigService
    {
        ...
        private Configuration GetUiDirectoryConfig()
        {
            ...
            var fileMap = bTestDirectory ? new ExeConfigurationFileMap { ExeConfigFilename = "../../../Jt76EmberBase.Ui/" + StrUiConfigName } : new ExeConfigurationFileMap { ExeConfigFilename = AppDomain.CurrentDomain.BaseDirectory + StrUiConfigName };
